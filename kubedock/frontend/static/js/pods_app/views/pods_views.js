define(['pods_app',
        'tpl!templates/layout_pod_list.tpl',
        'tpl!templates/pod_list_item.tpl',
        'tpl!templates/pod_list.tpl',
        'tpl!templates/layout_pod_item.tpl',
        'tpl!templates/page_header_title.tpl',
        'tpl!templates/page_info_panel.tpl',
        'tpl!templates/page_container_item.tpl',
        'tpl!templates/pod_item_controls.tpl',
        'tpl!templates/pod_item_graph.tpl',
        'tpl!templates/pod_item_main.tpl',
        'tpl!templates/pod_item_container.tpl',
        'tpl!templates/layout_wizard.tpl',
        'tpl!templates/breadcrumb_header.tpl',
        'tpl!templates/wizard_image_collection_item.tpl',
        'tpl!templates/wizard_get_image.tpl',
        'tpl!templates/wizard_set_container_ports.tpl',
        'tpl!templates/wizard_set_container_env.tpl',
        'tpl!templates/wizard_set_container_stats.tpl',
        'tpl!templates/wizard_set_container_logs.tpl',
        'tpl!templates/wizard_set_container_complete.tpl',
        'tpl!templates/paginator.tpl'],
       function(Pods,
                layoutPodListTpl, podListItemTpl, podListTpl, layoutPodItemTpl,
                pageHeaderTitleTpl, pageInfoPanelTpl, pageContainerItemTpl,
                podItemControlsTpl, podItemGraphTpl, podItemMainTpl,
                podItemContainerTpl, layoutWizardTpl, breadcrumbHeaderTpl,
                wizardImageCollectionItemTpl, wizardGetImageTpl,
                wizardSetContainerPortsTpl, wizardSetContainerEnvTpl,
                wizardSetContainerStatsTpl, wizardSetContainerLogsTpl,
                wizardSetContainerCompleteTpl, paginatorTpl){
    ...
    Pods.module('Views', function(Views, App, Backbone, Marionette, $, _){
