...
var UsersApp = new Backbone.Marionette.Application({
    regions: {
        contents: '#contents'
    }
});
...
UsersApp.module('Data', function(Data, App, Backbone, Marionette, $, _){
    ...
    Data.UsersCollection = Backbone.PageableCollection.extend({
        url: '/api/users/',
...
//            this.model.get('v').render();     //don't need, maybe in my case
    ...
    Views.UsersLayout = Backbone.Marionette.LayoutView.extend({
...
UsersApp.module('UsersCRUD', function(UsersCRUD, App, Backbone, Marionette, $, _){
    ...
    UsersCRUD.Controller = Marionette.Controller.extend({
        ...
        showUsers: function(){
            ...
            var users_list_view = new App.Views.UsersListView({collection: App.Data.users});
            var user_list_pager = new App.Views.PaginatorView({view: users_list_view});
        ...
        showEditUser: function(user_id){
            var layout_view = new App.Views.UsersLayout();
            var user_edit_view = new App.Views.UsersEditView({ model: App.Data.users.get(user_id) });
