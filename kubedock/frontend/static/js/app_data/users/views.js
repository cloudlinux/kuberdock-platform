define(['app_data/app', 'app_data/model', 'app_data/controller', 'app_data/utils',
        'app_data/users/templates/user_item.tpl',
        'app_data/users/templates/online_user_item.tpl',
        'app_data/users/templates/activity_item.tpl',
        'app_data/users/templates/users_list.tpl',
        'app_data/users/templates/online_users_list.tpl',
        'app_data/users/templates/users_activities.tpl',
        'app_data/users/templates/all_users_activities.tpl',
        'app_data/users/templates/user_create.tpl',
        'app_data/users/templates/user_profile_log_history.tpl',
        'app_data/users/templates/user_profile.tpl',
        'app_data/users/templates/users_layout.tpl',
        'jquery-ui/ui/widgets/datepicker',       // we don't need to import
        'jquery-ui/themes/base/datepicker.css',  // whole jquery-ui
        'bootstrap-select', 'bootstrap-3-typeahead'],
