define(['app_data/app', 'app_data/model', 'app_data/utils',
        'app_data/pods/templates/layout_wizard.tpl',
        'app_data/pods/templates/wizard_image_collection_item.tpl',
        'app_data/pods/templates/wizard_get_image.tpl',

        'app_data/pods/templates/wizard_set_container_pending_basic_settings.tpl',
        'app_data/pods/templates/public_access_controls.tpl',
        'app_data/pods/templates/editable_ports/list.tpl',
        'app_data/pods/templates/editable_ports/item.tpl',
        'app_data/pods/templates/editable_ports/empty.tpl',
        'app_data/pods/templates/editable_volume_mounts/list.tpl',
        'app_data/pods/templates/editable_volume_mounts/item.tpl',
        'app_data/pods/templates/editable_volume_mounts/empty.tpl',

        'app_data/pods/templates/wizard_set_container_env.tpl',
        'app_data/pods/templates/editable_env_vars/item.tpl',

        'app_data/pods/templates/wizard_container_collection_item.tpl',
        'app_data/pods/templates/wizard_set_container_complete.tpl',
        'bootstrap-editable', 'bootstrap-select', 'tooltip'],
